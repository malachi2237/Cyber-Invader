...
#-----------------------------------------------------------
func _process(delta):
	if (distance_traveled < entry_travel_distance): _dramaticEntrance(delta)
#-----------------------------------------------------------
...
func _concludeEntranceCondition() -> void:
	if (distance_traveled >= entry_travel_distance): _begin_attacking()
#-----------------------------------------------------------

#-----------------------------------------------------------
func _begin_attacking() -> void:
	var _smallAttackTimer = Utility.setupTimer(small_attack, true, small_attack_delay, "start_firing")
